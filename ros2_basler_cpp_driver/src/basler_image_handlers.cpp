...
namespace basler
{
    ...
    cv::Mat LeftMonoImageEventHandler::getLeftMonoImage() const
    {
        ...
        cv::Mat temp_left_mono_img;
        {
            std::lock_guard lock(_left_mono_mutex);
            temp_left_mono_img = _left_mono_image;
        }
